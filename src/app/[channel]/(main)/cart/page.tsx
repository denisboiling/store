	...
	if (!checkout || checkout.lines.length < 1) {
		return (
			<section className="mx-auto max-w-7xl p-8">
				...
				<p className="my-12 text-sm text-neutral-500">Похоже, вы ещё не добавили товары в корзину.</p>
				<LinkWithChannel
					href="/products"
						...
						<li key={item.id} className="flex py-4">
							...
							<div className="relative flex flex-1 flex-col justify-between p-4 py-2">
								...
								<div className="flex justify-between">
									<div className="text-sm font-bold">Кол-во: {item.quantity}</div>
				...
				<div className="mt-12">
					<div className="rounded border bg-neutral-50 px-4 py-2">
						<div className="flex items-center justify-between gap-2 py-2">
							<div>
								<p className="font-semibold text-neutral-900">Общая сумма</p>
